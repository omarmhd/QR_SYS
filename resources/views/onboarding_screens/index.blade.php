    ...
    <div class="row g-2 align-items-center">
      ...
      <div class="col-auto ms-auto d-print-none">
        <div class="btn-list">
          ...
          <a href="{{route('onboarding-screens.create')}}" class="btn btn-primary btn-5 d-none d-sm-inline-block">
            <svg
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Onboarding Screens Table</h3>
          </div>
            ...
            <table id="" class="table table-selectable card-table table-vcenter text-nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    @if($screen->image)
                    <img src="{{ asset('storage/'.$screen->image) }}" alt="Image" style="max-height: 60px;">
                    @else
                    <span>No image</span>
                    @endif
                  </td>
                ...
                @empty
                <tr>
                  <td colspan="5" class="text-center">No screens found.</td>
                </tr>
                @endforelse
                <!-- <tr>
