              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    @if($service->icon)
                    <img src="{{ asset('storage/'.$service->icon) }}" alt="Image" style="max-height: 60px;">
                  ...
                  <td>
                    {{-- Edit Button --}}
                    <a href="{{ route('services.edit', $service->id) }}" class="btn btn-bg btn-primary">
                    ...
                    <form action="{{ route('services.destroy', $service->id) }}" method="POST" style="display:inline;" class="delete-form">
